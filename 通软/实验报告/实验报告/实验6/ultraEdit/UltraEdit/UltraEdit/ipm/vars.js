...
var upgradeRightSideContent =
    '<img src="images/ue_uc_box_big.gif" alt="UltraEdit UltraCompare Bundle Box" border="0" class="ue_uc_box_big" />'+ 
		'<h2>UE/UC Bundle</h2>'+ 
		'<p class="ue_uc_bundle_offer">零售: <span class="retail_price" id="ueUcBundleRetailPrice">$89.90</span><br />'+ 
			'您付款: <span class="price" id="ueUpgradeToUeUcBundlePrice">$44.95</span><br />'+ 
			'您节省: <span class="you_save" id="ueUCBundleYouSavePercentage">50% on UC</span>'+ 
		'</p>'+ 
		'<p style="clear: both">购买升级的同时加购UltraCompare，后者又可以为您节省50%！加起来您一共：节省50 ％的升级，节省50 ％的UltraCompare ，还有一年的免费升级两种产品！</p>'+ 
	  '<div class="register_upgrade_container">'+ 
